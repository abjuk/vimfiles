...
syn keyword actionScriptKeyword				super var this
syn keyword actionScriptObjects				arguments Array Boolean Date _global Math Number Object String Accessibility Color Key _level Mouse _root Selection Sound Stage System TextFormat LoadVars XML XMLSocket XMLNode LoadVars Button TextField TextSnapshot CustomActions Error ContextMenu ContextMenuItem NetConnection NetStream Video PrintJob MovieClipLoader StyleSheet Camera LocalConnection Microphone SharedObject MovieClip
...
syn keyword actionScriptAS2 				class extends public private static interface implements dynamic evaluate package include use protected native internal override final 
syn keyword actionKeyword import const
...
syn region  actionScriptParen       transparent start="(" end=")" contains=ALLBUT,actionScrParenError
...
if version >= 508 || !exists("did_actionscript_syn_inits")
  ...
  HiLink actionScriptObjects		Type
  HiLink actionScriptKeyword		Keyword
  HiLink actionScriptStatement		Statement
  HiLink actionScriptFunction		Keyword
  ...
  HiLink as3Packages			Type
  HiLink as3Classes			Type
  "HiLink as3Properties			Identifier
  HiLink as3Functions			Function
  HiLink as3Constants			Constant
  HiLink as3Errors			Type
  HiLink as3Events			Type
  delcommand HiLink
endif
